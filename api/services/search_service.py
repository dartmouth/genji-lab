...
class SearchService(BaseService[AnnotationModel]):
    ...
    def _get_query_for_type(self, query_type: str):
        ...
        if sql_query is None:
            raise HTTPException(
                status_code=400,
                detail=f"Unrecognized search type: {query_type}"
            )
        return sql_query
    ...
    def search(
        ...
        Raises HTTPException 400 for invalid queries or search types.
        Raises HTTPException 500 for search execution failures.
        """
